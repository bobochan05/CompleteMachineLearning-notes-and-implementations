'''
SMOTE-
this is a type of oversampling where we generate new data points by KNN 
...
'''
disadvantages - 
1.computation cost is heavy
2.cannot handle categorical data 
3.finding the proper value of k is difficult
4.sensitive to outlier
5.Balanced points maynot represent True data 
